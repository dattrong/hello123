...
<html>
    ...
    <body style="background: pink" style="max-width: 100%" >
            ...
            <header>
                ...
                <div class="w3-container ">
                    ...
                    <div class="w3-bar w3-papayawhip" style="padding-left: 20%">
                        ...
                        <a href="admin.php"class="w3-bar-item w3-button w3-mobile" style="margin-left: 500px">Admin</a>
                    ...
                    <div class="list w3-row" style="color: plum">
                        ...
                        <div class="list w3-row" style="color: plum">
                            <div class=""id="BlackBaby" style="width: 500px"><h2>BlackBaby</h2>
                                ...
                                <div class="w3-pink w3-center w3-padding-24">LOVE YOU</div>
